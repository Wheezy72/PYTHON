...
Add REST-style clients, pagination, retries, timeout strategy, and rate limiting concepts.
...
```bash
python -m unittest discover -s topics/topic_11_advanced_web_apis/tests -p 'test_suite.py'
```
