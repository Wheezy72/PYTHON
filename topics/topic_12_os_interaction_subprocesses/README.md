# Topic 12: OS Interaction & Subprocesses
...
Add environment configuration, safe subprocess execution, process supervision, and shell-safety patterns.
...
```bash
python -m unittest discover -s topics/topic_12_os_interaction_subprocesses/tests -p 'test_suite.py'
```
